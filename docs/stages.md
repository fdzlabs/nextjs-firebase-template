...
1.  **Create the Workspace:**
    ...
    _This creates a new, empty state file for `staging` and automatically switches you to it._
...
3.  **Deploy:**
    ...
    _This will provision a fresh GCP project, Firebase app, etc._
...
- **Environment Variables (The Critical Link):**
  - Terraform injects the _correct_ Firebase config into Vercel's environment variables.
  - **Scenario:**
...
**Strategy:** _When you are ready to automate deployments_, your pipeline will need to know which stage to target.
